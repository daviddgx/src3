                                ...
                                <ul class="nav nav-tabs mb-3">
                                    <li class="nav-item">
                                        <a href="#home" data-toggle="tab" aria-expanded="false" class="nav-link">
                                            ...
                                            <span class="d-none d-lg-block">IDH - 0100015</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#profile" data-toggle="tab" aria-expanded="true" class="nav-link">
                                            <i class="mdi mdi-account-circle d-lg-none d-block mr-1"></i>
                                            <span class="d-none d-lg-block">IDH - 040017</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="home">
                                        ...
                                        <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                            ...
                                            for ($i = 0; $i < $lista_AsignacionesPRODUCCION; $i++) {
                                                ...
                                                echo "<td>";
                                                echo '<a href="UbicarProducto.php?Guia='.$IDGUIA.'&IDH='.$IDIDH.'&Ubicacion='.$Posicion.'" class="btn btn-success ">Ingresar</a>';
                                                echo "</td>";
                                    ...
                                    <div class="tab-pane show" id="profile">
                                        <table id="example2" class="table table-striped  " cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                            <?php
                                            for ($i = 0; $i < $lista_AsignacionesPRODUCCION2; $i++) {
                                                echo "<tr>";

                                                $IDGUIA = $lista_AsignacionesPRODUCCION2['Numero'];
                                                $IDIDH = $lista_AsignacionesPRODUCCION2['IDH'];
                                                $Posicion = $lista_AsignacionesPRODUCCION2['Posicion'];

                                                echo "<td>";
                                                echo $lista_AsignacionesPRODUCCION2['IDH'];
                                                echo "</td>";

                                                echo "<td>";
                                                echo $lista_AsignacionesPRODUCCION2['Producto'];
                                                echo "</td>";

                                                echo "<td>";
                                                echo $lista_AsignacionesPRODUCCION2['Posicion'];
                                                echo "</td>";

                                                echo "<td>";
                                                echo $lista_AsignacionesPRODUCCION2['Estado'];
                                                echo "</td>";
                                                ...
                                                echo "</tr>";
                                                $lista_AsignacionesPRODUCCION2 =$ejecutar_sentencia_Asignaciones2->fetch(PDO::FETCH_ASSOC);
                                            }
                                            ?>
                                            </tbody>
                                        </table>
