                                        ...
                                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                                            <div>
                                                <div class="d-inline-flex align-items-center">
                                                    ...
                                                    <span class="badge bg-success font-12 text-white font-weight-medium badge-pill ml-2 d-md-none d-lg-block"><?php echo bcdiv((($ListaDespachadas / $TotalMovimientos) *100),'1', 2) ;?>%</span>
                                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $(table.column(4).nodes()).addClass('bolded');
    });
</script>
