            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link has-arrow" href="javascript:void(0)"
                        ...
                        <ul aria-expanded="false" class="collapse  first-level base-level-line">
                            ...
                            <li class="sidebar-item"><a href="Guias_AsignarPikeador.php" class="sidebar-link"><span
                                            class="hide-menu"> Asignar Pickeador
                                        </span></a>
                            </li>
                            <li class="sidebar-item"><a href="Guias_ConteoCiego.php" class="sidebar-link"><span
                                            class="hide-menu"> Conteo Ciego
                                        </span></a>
                            </li>
                            <li class="sidebar-item"><a href="Guias_ConsultaGuas.php" class="sidebar-link"><span
                                            class="hide-menu"> Consulta de Guias
                                        </span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item"><a class="sidebar-link has-arrow " href="javascript:void(0)"
                        ...
                        <ul aria-expanded="false" class="collapse  first-level base-level-line">
                            <li class="sidebar-item"><a href="Formatos_CargaACiegas.php" class="sidebar-link"><span
                                            class="hide-menu"> Cargar a Ciegas
                                        </span></a>
                    ...
                    <li class="sidebar-item"><a class="sidebar-link has-arrow" href="javascript:void(0)"
                        ...
                        <ul aria-expanded="false" class="collapse  first-level base-level-line">
                            <li class="sidebar-item"><a href="Inventarios_Pallets.php" class="sidebar-link"><span
                                            class="hide-menu"> Pallets
                                        </span></a>
                            </li>
                            <li class="sidebar-item"><a href="Inventarios_Jaulas.php" class="sidebar-link"><span
                                            class="hide-menu"> Jaulas
                                        </span></a>
                            </li>
                    ...
                    <li class="sidebar-item"><a class="sidebar-link has-arrow" href="javascript:void(0)"
                                    ...
                                    class="hide-menu">Conteo Ciego </span></a>
                        <ul aria-expanded="false" class="collapse  first-level base-level-line">
                            <li class="sidebar-item"><a href="ConteoCiego_Porcentaje.php" class="sidebar-link"><span
                                            class="hide-menu"> Configuracion de %
                                        </span></a>
                            </li>
                            <li class="sidebar-item"><a href="ConteoCiego_ValidarGuia.php" class="sidebar-link"><span
                                            class="hide-menu"> Validar Guias
                                        </span></a>
                            </li>
                            <li class="sidebar-item"><a href="ConteoCiego_ConsultaHistorica.php" class="sidebar-link"><span
                                            class="hide-menu"> Consulta Historica
                                        </span></a>
                            </li>
                    ...
                    <li class="sidebar-item"><a class="sidebar-link sidebar-link" href="Mantenimiento_Posiciones.php"
                                                aria-expanded="false"><i
                                    class="fas fa-box"></i><span
                                    class="hide-menu">Posiciones
                                </span></a>
                    </li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Mantenimiento de Usuarios Administradores</h4>
                            <h6 class="card-subtitle">Registre Nuevos usuarios para el rol de Administrador FiFo </h6>
                            <br>
