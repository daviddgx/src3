                                    ...
                                    <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                        ...
                                        for ($i = 0; $i < $lista_Guias; $i++) {
                                            ...
                                            echo "<td>";
                                            {
                                                ...
                                                switch ($lista_Guias['Estatus']){
                                                    case 'Pendiente' :
                                                        break;
                                                    case 'FiFo Calculado' :
                                                        echo '<a href="DetalleGuiasDespachadas.php?Guia=' . $lista_Guias['Transporte'] . '&Entrega=' . $lista_Guias['Entrega'] . '" class="far fa-hourglass  btn btn-Sertero "></a>';
                                                        break;
...

                                            {
                                                ...
                                                switch ($lista_Guias['Estatus']){
                                                    case 'Pendiente' :
                                                        echo '<a href="Calcular.php?Guia=' . $lista_Guias['Transporte'] . '&Entrega=' . $lista_Guias['Entrega'] . '" class="far fa-paper-plane  btn btn-Sertero "></a>';
                                                        break;
