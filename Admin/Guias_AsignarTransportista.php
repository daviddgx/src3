                            ...
                            <div >
                                ...
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    for ($i = 0; $i < $lista_Guias; $i++) {
                                        ...
                                        echo "<td>";
                                        echo '<a href="AsignarPiloto.php?Guia=' . $lista_Guias['Transporte'] . '&Entrega=' . $lista_Guias['Entrega'] . '" class="  btn btn-outline-success">Completar Guia</a>';
                                        echo "</td>";

                                        echo "<td>";
                                        echo '<a href="DetalleGuiasTransportista.php?Guia=' . $lista_Guias['Transporte'] . '&Entrega=' . $lista_Guias['Entrega'] . '" class="  btn  btn-outline-info ">Cambiar Transportista</a>';
                                        echo "</td>";
