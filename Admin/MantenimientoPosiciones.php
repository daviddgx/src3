...
$MensajeExito = '';
$Mensajeerror = '';
$_SESSION['BODEGA_SESION'] = $_GET['Guia'];;
...
$TotalPosiciones = DarValorTotalPosiciones($_SESSION['BODEGA_SESION']);
$ProductosEnBodegas = DarValorTotOperadores($_SESSION['BODEGA_SESION']);
$ListaLibres = DarValorListaLibres($_SESSION['BODEGA_SESION']);
$Listaocupadas = DarValorListaOcupadas($_SESSION['BODEGA_SESION']); ;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Mantenimiento de Posiciones de la bodega <?php echo $BODEGA_SESION;?></h4>
