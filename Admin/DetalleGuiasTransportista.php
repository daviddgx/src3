...
try {
     ...
     if (isset($_GET['Guia'])) {
         $sql = "select FechaPedido,FechaEngrega,NombreDestino,Direccion,Lugar,Transportista,Piloto from  dbs9098416.Guias where Transporte ='" . $NoGuia . "' and entrega = '" . $NoEntrega . "';";
