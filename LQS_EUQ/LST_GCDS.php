...
try {
    ...
    $sqlDatos = "select Transporte,Entrega,FechaPedido,FechaEngrega,NombreDestino,lugar,Transportista,pais,Estatus,Piloto from dbs9098416.Guias where Estatus !='Finalizada'";
