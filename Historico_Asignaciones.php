...
<div class="preloader">
    <div class="lds-ripple">
        <div class="preloader">
            <br></br>
            <div class="logoPre">
                <img src="../assets/images/Sertero/LogoCBP.png" width="100px" height="auto">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link sidebar-link" href="Historico_Asignaciones.php"
                                    ...
                                    class="hide-menu">Asignaciones<br> realizadas
                                </span></a>
                    </li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Historico de Asignaciones</h4>
                            <h6 class="card-subtitle">Validar las asignaciones realizados en determinada fecha </h6>
                            <br>
